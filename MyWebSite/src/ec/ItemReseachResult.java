...
/**
 * Servlet implementation class ItemReseachResult
 */
@WebServlet("/ItemReseachResult")
public class ItemReseachResult extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher dispatcher =request.getRequestDispatcher("/WEB-INF/jsp/ItemReseachResult.jsp");
